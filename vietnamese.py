...
class App(CTk):
    def __init__(self):
        ...
        self.iconJaptor = CTkImage(Image.open('./icons/launch.png'), size=(50, 50))
        ...
        self.iconPayHD = CTkImage(Image.open('./icons/launch.png'), size=(50, 50))
        ...
        self.iconSkydrive = CTkImage(Image.open('./icons/launch.png'), size=(50, 50))
        self.buttonSkydrive = CTkButton(
            self.homeBottomFrame, text='Q.Hội', fg_color='#EEB186', hover_color='black',
            image=self.iconSkydrive, width=150, height=50,
            compound='left', anchor="w", font=CTkFont('Arial', size=16, weight='bold')
        )
        self.buttonSkydrive.pack(side='left', padx=(5, 0), pady=5)

        self.iconHieunu = CTkImage(Image.open('./icons/launch.png'), size=(50, 50))
        self.buttonHieunu = CTkButton(
            self.homeBottomFrame, text='Hiếu', fg_color='#76989B', hover_color='black',
        ...
        self.passwordSignupEntry = CTkEntry(self.registerFrame, width=240, placeholder_text="mật khẩu")
    ...
    def BookInfo(self, value):
        ...
        if (bookInfo[0][5] and (quantity)) != 0:
            self.listDetails.insert(5, 'Số lượng: khả dụng ' + str(quantity))
        else:
            self.listDetails.insert(5, 'Số lượng: không khả dụng')
