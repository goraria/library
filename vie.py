...
class App(CTk):
    def __init__(self):
        ...
        self.homeWelcomeLabel = CTkLabel(
            self.homeWelcomeFrame, text='Welcome to Gobrary', bg_color='transparent',
            text_color=('black', 'white'), font=CTkFont('Arial', size=32, weight='bold')
        )
        ...
        self.homeCopyrightLabel = CTkLabel(
            ...
            text_color=('black', 'white'), font=CTkFont('Arial', size=20, weight='bold')
        )
