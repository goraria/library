...
class App(CTk):
    def __init__(self):
        ...
        self.navigationFrameLabel = CTkLabel(
            self.navigationFrame, text='  Gorth Inc.', image=self.logoImage, # appImage
        ...
        self.iconLibrary = CTkImage(Image.open('./icons/calibre.png'), size=(50, 50)) # logo_modified
        self.buttonLibrary = CTkButton(
            self.homeTopFrame, text='Library', # Gorth Inc.
