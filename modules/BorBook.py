...
class App(CTk):
    def __init__(self):
        ...
        self.buttonBorBook = CTkButton(self.bookTopFrame, text='Borrow', image=self.iconBorBook, anchor="w", width=150,
        ...
        self.buttonBorBook.grid_forget()
        ...
        self.borFrame = CTkFrame(self.bookMainCenterFrame, width=600, height=600, fg_color=('#DBDBDB', '#2B2B2B'))
        ...
        self.borLabel = CTkLabel(self.borFrame, text="Borrow Book", font=CTkFont(family='Arial', size=20, weight="bold"))
        self.borLabel.grid(row=0, column=0, padx=30, pady=30)
        self.borNameEntry = CTkEntry(self.borFrame, width=320, placeholder_text="name book", font=CTkFont(family='Arial', size=14))
        self.borNameEntry.grid(row=2, column=0, padx=30, pady=(15, 15))
        self.borNameEntry = CTkEntry(self.borFrame, width=320, placeholder_text="id person", font=CTkFont(family='Arial', size=14))
        self.borNameEntry.grid(row=3, column=0, padx=30, pady=(0, 15))
        self.borFormButton = CTkButton(self.borFrame, text="Borrow", width=160)
