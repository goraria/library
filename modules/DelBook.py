...
class App(CTk):
    def __init__(self):
        ...
        self.delFrame = CTkFrame(self.bookMainCenterFrame, width=600, height=600, fg_color=('#DBDBDB', '#2B2B2B'))
        ...
        self.delLabel = CTkLabel(self.delFrame, text="Borrow Book", font=CTkFont(family='Arial', size=20, weight="bold"))
        self.delLabel.grid(row=0, column=0, padx=30, pady=30)
        self.delNameEntry = CTkEntry(self.delFrame, width=320, placeholder_text="name book", font=CTkFont(family='Arial', size=14))
        self.delNameEntry.grid(row=2, column=0, padx=30, pady=(15, 15))
        self.delNameEntry = CTkEntry(self.delFrame, width=320, placeholder_text="id person", font=CTkFont(family='Arial', size=14))
        self.delNameEntry.grid(row=3, column=0, padx=30, pady=(0, 15))
        self.delFormButton = CTkButton(self.delFrame, text="Borrow", width=160)
