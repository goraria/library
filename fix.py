...
class App(CTk):
    def __init__(self):
        ...
        self.navigationFrameLabel = CTkLabel(
            self.navigationFrame, text='  Gorth Inc.', image=self.logoImage,
        ...
        self.userButton = CTkButton(
            self.navigationFrame, height=50, text="Users",
        ...
        self.homeCenterFrame = CTkFrame(self.homeFrame, fg_color=('#555555', '#AAAAAA'))
        ...
        self.iconLibrary = CTkImage(Image.open('./icons/calibre.png'), size=(50, 50))
        self.buttonLibrary = CTkButton(
            self.homeTopFrame, text='Library',
            image=self.iconLibrary, width=150, height=50,
            compound='left', anchor="w", font=('Arial Bold', 16)
        )
        ...
        self.buttonNothing = CTkButton(
            ...
            compound='left', anchor="w", font=('Arial Bold', 16), state='disabled'
        )
        ...
        self.listBooks = CTkListbox(self.tab1, text_color=('black', 'white'), font=('Arial Bold', 14),
                                    command=self.BookInfo)  # , text_color=('black', 'white'), hover_color=('gray75', 'gray25')
        self.listBooks.grid(row=0, column=0, padx=(10, 0), pady=(0, 10), sticky='nsew')
        self.listDetails = CTkListbox(self.tab1, text_color=('black', 'white'), font=('Arial Bold', 14))
        self.listDetails.grid(row=0, column=1, padx=(10, 10), pady=(0, 10), sticky='nsew')
        ##
        self.labelBookCount = CTkLabel(self.tab2, text='', font=('Arial Bold', 20))
        self.labelBookCount.grid(row=0, padx=50, pady=(50, 20), sticky='w')
        self.labelMemberCount = CTkLabel(self.tab2, text='a', font=('Arial Bold', 20))
        self.labelMemberCount.grid(row=1, padx=50, pady=20, sticky='w')
        self.labelTakenCount = CTkLabel(self.tab2, text='a', font=('Arial Bold', 20))
        ...
        self.searchBar0 = CTkLabel(self.searchBar, text='Search Box', fg_color='transparent',
                                   text_color=('black', 'white'), font=('Arial Bold', 24))
        ...
        self.labelSearch = CTkLabel(self.searchBar1, text='Search: ', text_color=('black', 'white'),
                                    font=('Arial Bold', 18))
        self.labelSearch.grid(row=1)
        self.entrySearch = CTkEntry(self.searchBar2, font=('Arial', 16), width=320)
        self.entrySearch.grid(row=2)
        self.buttonSearch = CTkButton(self.searchBar3, text='Search', width=160, font=('Arial Bold', 16),
        ...
        self.listBar0 = CTkLabel(self.listBar, text='List Box', fg_color='transparent', text_color=('black', 'white'),
                                 font=('Arial Bold', 24))
        ...
        self.labelList = CTkLabel(self.listBar1, text='Sort by:', text_color=('black', 'white'),
                                  font=('Arial Bold', 18))
        self.labelList.grid(row=1)
        self.listChoice = IntVar()
        ##
        self.radioButton1 = CTkRadioButton(self.listBar2, text='All Books', variable=self.listChoice, value=1,
                                           font=('Arial Bold', 12))
        self.radioButton2 = CTkRadioButton(self.listBar2, text='In Library', variable=self.listChoice, value=2,
                                           font=('Arial Bold', 12))
        self.radioButton3 = CTkRadioButton(self.listBar2, text='Borrowed Books', variable=self.listChoice, value=3,
                                           font=('Arial Bold', 12))
        self.radioButton1.grid(row=0, column=0)
        self.radioButton2.grid(row=0, column=1)
        self.radioButton3.grid(row=0, column=2)
        self.buttonList = CTkButton(self.listBar3, text='List Books', width=160, font=('Arial Bold', 16),
        ...
        self.borLabel = CTkLabel(self.borFrame, text="Borrow Book",
                                 font=CTkFont(family='Arial', size=20, weight="bold"))
        self.borLabel.grid(row=0, column=0, padx=30, pady=30)
        self.borNameEntry = CTkEntry(self.borFrame, width=320, placeholder_text="name book",
        ...
        self.rtnLabel = CTkLabel(self.rtnFrame, text="Return Book",
                                 font=CTkFont(family='Arial', size=20, weight="bold"))
        self.rtnLabel.grid(row=0, column=0, padx=30, pady=30)
        self.rtnNameEntry = CTkEntry(self.rtnFrame, width=320, placeholder_text="name book",
                                     font=CTkFont(family='Arial', size=14))
        ...
        self.addNameEntry = CTkEntry(self.addFrame, width=320, placeholder_text="name book",
                                     font=CTkFont(family='Arial', size=14))
        self.addNameEntry.grid(row=1, column=0, padx=30, pady=(15, 15))
        self.addAuthorEntry = CTkEntry(self.addFrame, width=320, placeholder_text="author",
                                       font=CTkFont(family='Arial', size=14))
        self.addAuthorEntry.grid(row=2, column=0, padx=30, pady=(0, 15))
        self.addPublisherEntry = CTkEntry(self.addFrame, width=320, placeholder_text="publisher",
                                          font=CTkFont(family='Arial', size=14))
        self.addPublisherEntry.grid(row=3, column=0, padx=30, pady=(0, 15))
        self.addTypesEntry = CTkEntry(self.addFrame, width=320, placeholder_text="types",
                                      font=CTkFont(family='Arial', size=14))
        self.addTypesEntry.grid(row=4, column=0, padx=30, pady=(0, 15))
        self.addQuantityEntry = CTkEntry(self.addFrame, width=320, placeholder_text="quantity",
                                         font=CTkFont(family='Arial', size=14))
        self.addQuantityEntry.grid(row=5, column=0, padx=30, pady=(0, 15))
        self.addContentEntry = CTkEntry(self.addFrame, width=320, placeholder_text="content",
                                        font=CTkFont(family='Arial', size=14))
        self.addContentEntry.grid(row=6, column=0, padx=30, pady=(0, 15))
        self.addStoragedEntry = CTkEntry(self.addFrame, width=320, placeholder_text="storaged",
                                         font=CTkFont(family='Arial', size=14))
        ...
        self.delLabel = CTkLabel(self.delFrame, text="Delete Book",
                                 font=CTkFont(family='Arial', size=20, weight="bold"))
        self.delLabel.grid(row=0, column=0, padx=30, pady=30)
        self.delNameEntry = CTkEntry(self.delFrame, width=320, placeholder_text="name book",
                                     font=CTkFont(family='Arial', size=14))
        self.delNameEntry.grid(row=1, column=0, padx=30, pady=(15, 15))
        self.delAuthorEntry = CTkEntry(self.delFrame, width=320, placeholder_text="author",
                                       font=CTkFont(family='Arial', size=14))
        self.delAuthorEntry.grid(row=2, column=0, padx=30, pady=(0, 15))
        self.delPublisherEntry = CTkEntry(self.delFrame, width=320, placeholder_text="publisher",
                                          font=CTkFont(family='Arial', size=14))
        self.delPublisherEntry.grid(row=3, column=0, padx=30, pady=(0, 15))
        self.delQuantityEntry = CTkEntry(self.delFrame, width=320, placeholder_text="quantity",
                                         font=CTkFont(family='Arial', size=14))
        self.delQuantityEntry.grid(row=4, column=0, padx=30, pady=(0, 15))
        self.delStoragedEntry = CTkEntry(self.delFrame, width=320, placeholder_text="storaged",
                                         font=CTkFont(family='Arial', size=14))
        ...
        self.signinLabel = CTkLabel(self.signinFrame, text="Sign in",
                                    font=CTkFont(family='Arial', size=20, weight="bold"))
        ...
        self.signupLabel = CTkLabel(self.signupFrame, text="Sign up",
                                    font=CTkFont(family='Arial', size=20, weight="bold"))
        ...
        self.registerLabel = CTkLabel(self.registerFrame, text="Register",
                                      font=CTkFont(family='Arial', size=20, weight="bold"))
        ...
        self.radioMaleButton = CTkRadioButton(self.genderSignupFrame, text='Male', variable=self.genderChoice,
                                              value='male', font=('Arial Bold', 12))
        self.radioFemaleButton = CTkRadioButton(self.genderSignupFrame, text='Female', variable=self.genderChoice,
                                                value='female', font=('Arial Bold', 12))
        ...
        self.birthdateSignupEntry = CTkEntry(self.birthdaySignupFrame, width=40, placeholder_text="day")
        self.birthdateSignupEntry.grid(row=0, column=0, padx=(0, 30), sticky='e')
        self.birthmonthSignupEntry = CTkEntry(self.birthdaySignupFrame, width=40, placeholder_text="month")
            ...
            if myCursor.execute(check, (name_book, author, publisher, types, storage, content)) == 0:
                try:
                    ...
                    messagebox.showinfo('Success', 'Successfully',
                                        icon='info')  # CTkMessagebox(message='Successfully', icon='check')
                except:
                    messagebox.showerror('Error', "Can't connect to Database",
                                         icon='error')  # CTkMessagebox(message="Can't connect to Database", icon='cancel')
            else:
                ...
                myConnect.commit()
                messagebox.showwarning('Warning', 'Book was in Database',
                                       icon='warning')  # CTkMessagebox(message='Book was in Database', icon='warning')
        else:
            messagebox.showwarning('Warning', "Form can't be Empty",
                                   icon='warning')  # CTkMessagebox(message="Form can't be Empty", icon='warning')
        ...
        if (name_book and author and publisher and quantity and storage) != '':
            ...
            if myCursor.execute(checkmore, (name_book, author, publisher, int(quantity), storage)) != 0:
                ...
                try:
                    ...
                    myConnect.commit()
                    messagebox.showinfo('Success', 'Deleted quantity of book',
                                        icon='info')  # CTkMessagebox(message='Book was in Database', icon='warning')
                except:
                    messagebox.showerror('Error', "Can't connect to Databases",
                                         icon='error')  # CTkMessagebox(message="Can't connect to Database", icon='cancel')
            else:
