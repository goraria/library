...
class BorrowsBook(Book):
    def __init__(self, id_person, id_librarian, id_book, borrowed_date, paid_date, paid=False, notes=''):
        super().__init__()
...
class PaidForm:
    def __init__(self, id_person, id_librarian, id_book, borrowed_date, paid_date):
        super().__init__()
        self.id_card = id_person
        self.id_librarian = id_librarian
        self.id_book = id_book
